...
export default function Footer() {
  return (
    <motion.footer
      ...
      animate="animate"
      variants={fadeIn}
      className="bg-black border-t border-gray-800 py-8 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Mohamed Refaat Design. All rights reserved.
          </p>
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium">@mohamedrefaat.designs</span>
            </motion.a>
            <motion.p
